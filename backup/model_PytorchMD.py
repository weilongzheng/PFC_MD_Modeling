...
class PytorchPFC(nn.Module):
    ...
    def init_weights(self):
        ...
        # self.Jrec.requires_grad = True    %%% NL: Verify that this is not needed anymore, with MD integrated to pytorch.
    ...
    def forward(self, input, target, *args, **kwargs):
        ...
        for i in range(n_time):
            ...
            if self.MDeffect:
                ...
                ### NL test. Question: Can these be simplified, maybe incoporated to PytorchMD?
